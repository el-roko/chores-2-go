            ...
            <div class="col-lg-10 col-md-9 main-content">
                ...
                <div class="form-card">
                    <div class="section-title">
                        <i class="bi bi-plus-circle-fill"></i> Add Services Plan
                    </div>
                    <form action="process/process_add_service_plan.php" method="post">
                        <?php require_once "partials/feedback.php"; ?>

                        <div class="mb-3">
                            <label for="servname" class="form-label"><i class="bi bi-tag me-1"></i>Service Plan Name</label>
                            <input type="text" name="servname" id="servname" class="form-control" placeholder="Enter service plan name">
                        </div>
                        <div class="mb-3">
                            <label for="desc" class="form-label"><i class="bi bi-text-paragraph me-1"></i>Description</label>
                            <textarea name="desc" id="desc" class="form-control" placeholder="Enter plan description"></textarea>
                        </div>
