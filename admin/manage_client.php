                    ...
                    <div class="table-responsive">
                        <table class="table-modern">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><span class="fw-bold text-secondary"><?php echo $client['client_id']; ?></span></td>
                                    <td><?php echo htmlspecialchars($client['client_fname'].' '.$client['client_lname']); ?></td>
                                    <td><?php echo htmlspecialchars($client['cl_email']); ?></td>
                                    <td><span class="text-muted small"><?php echo date("Y-m-d H:i", strtotime($client['registered_on'])); ?></span></td>
                                    <td>
                                       <?php if($client['status'] === "active"): ?>
                                        <span class="status-badge active"><?php echo $client['status']; ?></span>
                                        <?php else: ?>
                                            <span class="status-badge inactive">Inactive</span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="text-center">
                                        <form action="process/process_cl_status.php" method="POST" style="display:inline;">
                                ...
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-4">
                                        <i class="bi bi-inbox me-2"></i>No clients found
                                    </td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
