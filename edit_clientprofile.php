...
<head>
  ...
  <title>Update Profile · Modern</title>
  ...
  <div class="profile-banner">
    <div class="row align-items-center">
      <div class="col-md-8">
        ...
        <p class="lead fs-6">Keep your information fresh and accurate</p>
  ...
  <div class="row g-4">
    ...
    <div class="col-lg-4 col-md-5">
      <div class="profile-card">
        <form action="process/process_cl_image.php" method="post" enctype="multipart/form-data">
    ...
    <div class="col-lg-8 col-md-7">
      <div class="card-modern">
        ...
        <form action="process/process_edit_cp.php" method="post" id="editform">
          <div class="row g-3">
            <div class="col-md-6">
              <label for="fname" class="form-label">First Name</label>
              <input type="text" name="fname" id="fname" value="<?php echo $record["client_fname"] ?? ''; ?>" class="form-control" required>
            </div>
            <div class="col-md-6">
              <label for="lname" class="form-label">Last Name</label>
              <input type="text" name="lname" id="lname" value="<?php echo $record["client_lname"] ?? ''; ?>" class="form-control" required>
            </div>
            <div class="col-md-6">
              <label for="email" class="form-label">Email</label>
              <input type="email" name="email" id="email" value="<?php echo $record["cl_email"] ?? ''; ?>" class="form-control" required>
            </div>
            <div class="col-md-6">
              <label for="phone" class="form-label">Phone Number</label>
              <input type="tel" name="phone" id="phone" value="<?php echo $record["cl_phone"] ?? ''; ?>" class="form-control" required>
            </div>
            <div class="col-md-6">
              <label for="dob" class="form-label">Date of Birth</label>
              <input type="date" name="dob" id="dob" value="<?php echo $record["client_dateofbirth"] ?? ''; ?>" class="form-control">
            </div>
            <div class="col-md-6">
              <label for="mstatus" class="form-label">Marital Status</label>
              <select name="mstatus" id="mstatus" class="form-select">
                <option value="single" <?php if(($record['cl_marital'] ?? '')=='single') echo 'selected'; ?>>Single</option>
                <option value="married" <?php if(($record['cl_marital'] ?? '')=='married') echo 'selected'; ?>>Married</option>
                <option value="divorced" <?php if(($record['cl_marital'] ?? '')=='divorced') echo 'selected'; ?>>Divorced</option>
                <option value="widow" <?php if(($record['cl_marital'] ?? '')=='widow') echo 'selected'; ?>>Widow</option>
                <option value="widower" <?php if(($record['cl_marital'] ?? '')=='widower') echo 'selected'; ?>>Widower</option>
              </select>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-12">
              ...
              <input type="text" name="address" id="address" value="<?php echo $record["cl_address"] ?? ''; ?>" class="form-control" required>
            </div>
            <div class="col-md-12">
              <div class="radio-group">
                <label class="form-label d-block mb-1">Gender</label>
                <div>
                  <input type="radio" name="sex" id="msex" value="male" <?php if(($record['client_gender'] ?? '')=='male') echo 'checked'; ?>>
                  <label for="msex" class="me-3">Male</label>
                  <input type="radio" name="sex" id="fsex" value="female" <?php if(($record['client_gender'] ?? '')=='female') echo 'checked'; ?>>
          ...
          <div class="d-flex gap-3 mt-4 flex-wrap">
            ...
            <a href="profile.php" class="btn btn-outline-modern"><i class="bi bi-arrow-left me-2"></i>Cancel</a>
            <a href="change_cl_password.php" class="btn btn-outline-modern"><i class="bi bi-lock me-2"></i>Change Password</a>
          </div>
        </form>
      </div>
    </div>
...
<script>
  $(function(){
    ...
    function loadLgas(stateId, selectedLga) {
      ...
      $.ajax({
        url: "process/process_state_cp.php",
        type: "POST",
