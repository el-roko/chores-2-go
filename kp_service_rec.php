...
$bookings = $kp->fetch_kp_bookings($_SESSION["useronline"]);
...
<head>
  ...
  <title>Keeper Dashboard · Chores-2-Go</title>
  ...
  <style>
    * { font-family: 'Inter', sans-serif; }
    ...
    @media (max-width: 768px) {
      ...
      .table-modern thead th { font-size: 0.6rem; }
    }
  </style>
</head>
<body>
...
<div class="container-fluid px-3 px-md-4">
  ...
  <div class="banner-modern">
    <div class="row align-items-center">
      <div class="col-md-8">
        <h1 class="display-6 fw-bold">Welcome, <?php echo strtoupper($record["keeper_fname"] ?? 'Keeper'); ?>!</h1>
        <p class="lead fs-6">Your personal dashboard · manage bookings &amp; services</p>
        <?php require_once "partials/feedback.php"; ?>
        <div id="notification-area" class="mt-2"></div>
      </div>
    ...
    <div class="col-lg-9 col-md-8">
      ...
      <div class="card-modern p-3 p-md-4">
        <div class="d-flex align-items-center justify-content-between mb-3">
          <h5 class="section-title mb-0"><i class="bi bi-table me-2" style="color:#2a3b5c;"></i>Bookings</h5>
          ...
          <table class="table-modern">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><span class="fw-medium"><?php echo $s["client_fname"] ?? ''; ?> <?php echo $s["client_lname"] ?? ''; ?></span></td>
                ...
                <td>
                  <?php 
                    ...
                    else if($status == 'active') $class = 'active';
                  ?>
  ...
  <div class="duplicate-actions">
    <div class="row my-5 justify-content-center">
      ...
      <div class="col-md-2"><div class="card action-card"><div class="card-body text-center"><a href="kp_track_status.php" class="card-link fw-bold">Track Status</a></div></div></div>
      <div class="col-md-2"><div class="card action-card"><div class="card-body text-center"><a href="#" class="card-link fw-bold">Service History</a></div></div></div>
    </div>
  </div>
